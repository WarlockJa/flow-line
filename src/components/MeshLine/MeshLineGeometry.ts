  ...
  #makeNewBuffers(pointCount) {
    ...
    this.#attributes = {
      position: new BufferAttribute(
        (this.#positions = new Float32Array(pointCount * itemSize)),
        3
      ),
      previous: new BufferAttribute(
        (this.#previous = new Float32Array(pointCount * itemSize)),
        3
      ),
      next: new BufferAttribute(
        (this.#next = new Float32Array(pointCount * itemSize)),
        3
      ),
      side: new BufferAttribute(
        (this.#side = new Float32Array(pointCount * 2)),
        1
      ),
      width: new BufferAttribute(
        (this.#width = new Float32Array(pointCount * 2)),
        1
      ),
      ...
      counters: new BufferAttribute(
        (this.#counters = new Float32Array(pointCount * 2)),
        1
      ),
      index: new BufferAttribute(
        (this.#indices = new Uint16Array((pointCount - 1) * itemSize)),
        1
      ),
    };
